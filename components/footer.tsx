    ...
    <footer className="bg-muted text-muted-foreground">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-foreground">Vibrato Bolivia</span>
            </div>
            
            <p className="mb-6 max-w-md">
              La mejor academia de música online para toda Bolivia. Aprende violín, canto y guitarra 
        ...
        <div className="border-t border-border mt-8 pt-8 text-center">
          ...
          <p>&copy; 2024 Vibrato Academia de Musica Online Bolivia. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  )
